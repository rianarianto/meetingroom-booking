...
<head>
    ...
    <title>Yotek Meeting Room</title>
    ...
    <!-- Favicon -->
    <link href="{{ asset('img/yotek2.png') }}" rel="icon" type="image/png">
</head>
<body id="page-top">
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gold sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Sidebar - Brand -->
        <a class="sidebar-brand bg-white d-flex align-items-center justify-content-center" href="{{ url('/') }}">
            <div class="sidebar-brand-icon">
                {{-- <i class="fas fa-laugh-wink"></i> --}}
                <img style="max-width: 100%;" src="{{ url('img/yotek.png') }}" alt="">
            </div>
        ...
        {{-- Nav Item Booking --}}
        <li class="nav-item {{ Nav::isRoute('bookingList') }}">
            <a class="nav-link" href="{{ route('bookingList') }}">
                <i class="fas fa-fw fa-list"></i>
                <span>{{ __('List Booking') }}</span>
            </a>
        </li>

        <li class="nav-item {{ Nav::isRoute('bookingAdd') }}">
            <a class="nav-link" href="{{ route('bookingAdd') }}">
                <i class="fas fa-fw fa-plus"></i>
                <span>{{ __('Tambah Booking') }}</span>
            </a>
        </li>
        ...
        <li class="nav-item {{ Nav::isRoute('ruangan') }}">
            <a class="nav-link" href="{{ route('ruangan') }}">
                <i class="fas fa-fw fa-list"></i>
                <span>{{ __('List Ruangan') }}</span>
            </a>
        </li>
        
        @if (Auth::user() != '')
        <li class="nav-item {{ Nav::isRoute('createRuangan') }}">
            <a class="nav-link" href="{{ route('createRuangan') }}">
                <i class="fas fa-fw fa-plus"></i>
                <span>{{ __('Tambah Ruangan') }}</span>
            </a>
        </li>
        @endif
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <!-- Topbar Search -->
                <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" action="{{ route('booking.cari') }}">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow d-sm-none">
                        ...
                        <div class="dropdown-menu dropdown-menu-right p-3 shadow animated--grow-in" aria-labelledby="searchDropdown">
                            <form class="form-inline mr-auto w-100 navbar-search" action="{{ route('booking.cari') }}">
                                <div class="input-group">
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; ryanarians {{ now()->year }}</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
