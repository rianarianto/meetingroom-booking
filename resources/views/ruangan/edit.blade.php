                                ...
                                <div class="col-lg-6 col-sm-6 col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            {{-- <div class="col">
                                                <button style="padding: 10px" class="btn btn-gold btn-sm btn-flat" data-toggle="modal" data-target="#modaledit-add"><i class="fa fa-plus"></i></button>
                                            </div> --}}
                                        </div>
...
<!-- modal add data-->
<div class="modal inmodal fade" id="modaledit-add" tabindex="-1" role="dialog" aria-hidden="true">
